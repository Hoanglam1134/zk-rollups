...
// TransferLayer2 is a paid mutator transaction binding the contract method 0x65ca1326.
//
// Solidity: function transferLayer2(bytes32 fromX, bytes32 fromY, bytes32 toX, bytes32 toY, uint256 amount, bytes32 r8x, bytes32 r8y, bytes32 s) returns()
func (_MiddlewareContract *MiddlewareContractTransactor) TransferLayer2(opts *bind.TransactOpts, fromX [32]byte, fromY [32]byte, toX [32]byte, toY [32]byte, amount *big.Int, r8x [32]byte, r8y [32]byte, s [32]byte) (*types.Transaction, error) {
	return _MiddlewareContract.contract.Transact(opts, "transferLayer2", fromX, fromY, toX, toY, amount, r8x, r8y, s)
}

// TransferLayer2 is a paid mutator transaction binding the contract method 0x65ca1326.
//
// Solidity: function transferLayer2(bytes32 fromX, bytes32 fromY, bytes32 toX, bytes32 toY, uint256 amount, bytes32 r8x, bytes32 r8y, bytes32 s) returns()
func (_MiddlewareContract *MiddlewareContractSession) TransferLayer2(fromX [32]byte, fromY [32]byte, toX [32]byte, toY [32]byte, amount *big.Int, r8x [32]byte, r8y [32]byte, s [32]byte) (*types.Transaction, error) {
	return _MiddlewareContract.Contract.TransferLayer2(&_MiddlewareContract.TransactOpts, fromX, fromY, toX, toY, amount, r8x, r8y, s)
}

// TransferLayer2 is a paid mutator transaction binding the contract method 0x65ca1326.
//
// Solidity: function transferLayer2(bytes32 fromX, bytes32 fromY, bytes32 toX, bytes32 toY, uint256 amount, bytes32 r8x, bytes32 r8y, bytes32 s) returns()
func (_MiddlewareContract *MiddlewareContractTransactorSession) TransferLayer2(fromX [32]byte, fromY [32]byte, toX [32]byte, toY [32]byte, amount *big.Int, r8x [32]byte, r8y [32]byte, s [32]byte) (*types.Transaction, error) {
	return _MiddlewareContract.Contract.TransferLayer2(&_MiddlewareContract.TransactOpts, fromX, fromY, toX, toY, amount, r8x, r8y, s)
}
...
// FilterETransfer is a free log retrieval operation binding the contract event 0xb2a9fcb27927416e8a4cb5a7c4fffa19e0f58f47ab10ce025498baa4cc743ae4.
//
// Solidity: event eTransfer(bytes32 fromX, bytes32 fromY, bytes32 toX, bytes32 toY, uint256 amount, bytes32 r8x, bytes32 r8y, bytes32 s)
...
// WatchETransfer is a free log subscription operation binding the contract event 0xb2a9fcb27927416e8a4cb5a7c4fffa19e0f58f47ab10ce025498baa4cc743ae4.
//
// Solidity: event eTransfer(bytes32 fromX, bytes32 fromY, bytes32 toX, bytes32 toY, uint256 amount, bytes32 r8x, bytes32 r8y, bytes32 s)
...
// ParseETransfer is a log parse operation binding the contract event 0xb2a9fcb27927416e8a4cb5a7c4fffa19e0f58f47ab10ce025498baa4cc743ae4.
//
// Solidity: event eTransfer(bytes32 fromX, bytes32 fromY, bytes32 toX, bytes32 toY, uint256 amount, bytes32 r8x, bytes32 r8y, bytes32 s)
