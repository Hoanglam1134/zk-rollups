...
uint get_main_input_signal_no() {return 74;}

uint get_total_signal_no() {return 107683;}

uint get_number_of_components() {return 8077;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 43291;}
...
uint csoffset = mySignalStart+20742;
...
uint aux_create = 4;
int aux_cmp_num = 24+ctx_index+1;
uint csoffset = mySignalStart+5986;
uint aux_dimensions[1] = {4};
for (uint i = 0; i < 4; i++) {
...
uint csoffset = mySignalStart+14830;
...
uint aux_dimensions[2] = {4,2};
for (uint i = 0; i < 8; i++) {
std::string new_cmp_name = "intermediateRootCheck"+ctx->generate_position_array(aux_dimensions, 2, i);
MultiMiMC7_29_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+i] = aux_cmp_num;
csoffset += 739 ;
aux_cmp_num += 3;
...
Fr_lt(&expaux[0],&lvar[4],&circuitConstants[8]); // line circom 38
while(Fr_isTrue(&expaux[0])){
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[4])) + 26)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[4])) + 30)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
MultiMiMC7_1_run(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[4])) + 38)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
MultiMiMC7_1_run(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[4])) + 42)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
MultiMiMC7_1_run(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[4])) + 46)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
EdDSAMiMCVerifier_28_run(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[4])) + 50)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
EdDSAMiMCVerifier_28_run(mySubcomponents[cmp_index_ref],ctx);
...
Fr_lt(&expaux[0],&lvar[5],&circuitConstants[4]); // line circom 60
while(Fr_isTrue(&expaux[0])){
Fr_eq(&expaux[0],&lvar[5],&circuitConstants[1]); // line circom 62
if(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[6];
// load src
...
// load src
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((2 * Fr_toInt(&lvar[4])) + 0) + 8)]].signalStart + 0]);
}
}
{
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
Fr_sub(&expaux[4],&lvar[6],&signalValues[mySignalStart + (((2 * Fr_toInt(&lvar[4])) + (1 * Fr_toInt(&lvar[5]))) + 58)]); // line circom 62
Fr_mul(&expaux[2],&signalValues[mySignalStart + (((2 * Fr_toInt(&lvar[4])) + (1 * Fr_toInt(&lvar[5]))) + 66)],&expaux[4]); // line circom 62
Fr_add(&expaux[0],&signalValues[mySignalStart + (((2 * Fr_toInt(&lvar[4])) + (1 * Fr_toInt(&lvar[5]))) + 58)],&expaux[2]); // line circom 62
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// run sub component if needed
...
Fr_eq(&expaux[0],&lvar[5],&circuitConstants[1]); // line circom 63
if(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[7];
// load src
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_sub(&expaux[4],&signalValues[mySignalStart + (((2 * Fr_toInt(&lvar[4])) + (1 * Fr_toInt(&lvar[5]))) + 58)],&lvar[7]); // line circom 63
Fr_mul(&expaux[2],&signalValues[mySignalStart + (((2 * Fr_toInt(&lvar[4])) + (1 * Fr_toInt(&lvar[5]))) + 66)],&expaux[4]); // line circom 63
Fr_add(&expaux[0],&lvar[8],&expaux[2]); // line circom 63
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// run sub component if needed
...
PFrElement aux_dest = &lvar[5];
// load src
Fr_add(&expaux[0],&lvar[5],&circuitConstants[2]); // line circom 60
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[5],&circuitConstants[4]); // line circom 60
}
Fr_eq(&expaux[0],&signalValues[mySignalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((2 * Fr_toInt(&lvar[4])) + 1) + 8)]].signalStart + 0]); // line circom 66
...
assert(Fr_isTrue(&expaux[0]));
{
uint cmp_index_ref = (((2 * Fr_toInt(&lvar[4])) + 0) + 16);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
Fr_sub(&expaux[4],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[4])) + 6)],&signalValues[mySignalStart + (((2 * Fr_toInt(&lvar[4])) + 0) + 10)]); // line circom 77
Fr_mul(&expaux[2],&signalValues[mySignalStart + (((2 * Fr_toInt(&lvar[4])) + 0) + 18)],&expaux[4]); // line circom 77
Fr_add(&expaux[0],&signalValues[mySignalStart + (((2 * Fr_toInt(&lvar[4])) + 0) + 10)],&expaux[2]); // line circom 77
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// run sub component if needed
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_sub(&expaux[4],&signalValues[mySignalStart + (((2 * Fr_toInt(&lvar[4])) + 0) + 10)],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[4])) + 6)]); // line circom 78
Fr_mul(&expaux[2],&signalValues[mySignalStart + (((2 * Fr_toInt(&lvar[4])) + 0) + 18)],&expaux[4]); // line circom 78
Fr_add(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[4])) + 6)],&expaux[2]); // line circom 78
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// run sub component if needed
...
Fr_lt(&expaux[0],&lvar[5],&circuitConstants[4]); // line circom 80
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = (((2 * Fr_toInt(&lvar[4])) + 1) + 16);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
Fr_sub(&expaux[4],&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((2 * Fr_toInt(&lvar[4])) + 0) + 16)]].signalStart + 0],&signalValues[mySignalStart + (((2 * Fr_toInt(&lvar[4])) + 1) + 10)]); // line circom 82
Fr_mul(&expaux[2],&signalValues[mySignalStart + (((2 * Fr_toInt(&lvar[4])) + 1) + 18)],&expaux[4]); // line circom 82
Fr_add(&expaux[0],&signalValues[mySignalStart + (((2 * Fr_toInt(&lvar[4])) + 1) + 10)],&expaux[2]); // line circom 82
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// run sub component if needed
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_sub(&expaux[4],&signalValues[mySignalStart + (((2 * Fr_toInt(&lvar[4])) + 1) + 10)],&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((2 * Fr_toInt(&lvar[4])) + 0) + 16)]].signalStart + 0]); // line circom 83
Fr_mul(&expaux[2],&signalValues[mySignalStart + (((2 * Fr_toInt(&lvar[4])) + 1) + 18)],&expaux[4]); // line circom 83
Fr_add(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((2 * Fr_toInt(&lvar[4])) + 0) + 16)]].signalStart + 0],&expaux[2]); // line circom 83
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// run sub component if needed
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[(((2 * Fr_toInt(&lvar[4])) + 1) + 16)]].signalStart + 0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[4])) + 2)]); // line circom 86
...
PFrElement aux_dest = &lvar[4];
// load src
Fr_add(&expaux[0],&lvar[4],&circuitConstants[2]); // line circom 38
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[4],&circuitConstants[8]); // line circom 38
